      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                  ...
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        ...
                        <img src={{asset('/images/avatar3.png')}} class="img-circle" >
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <img src={{asset('/images/avatar3.png')}} class="user-image" >
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{Auth::user()->name}}</p>
          <a href="#"><i class="fa fa-circle text-success"></i>main menu </a>
        </div>
      </div>
      <!-- search form -->
...
{!!Html::script('admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.j')!!}
